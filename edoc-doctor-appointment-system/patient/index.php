            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Counsellors</p></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about counsellors? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Counsellors"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                Track your past and future appointments history.<br>Also find out the expected arrival time of your Counsellor.<br><br>
                            </p>
                            
                            <h3>Channel a Counsellor Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search Counsellor and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
